...
import com.example.alina.testtesta.FragmentForDataAdapter;
import com.example.alina.testtesta.R;
import com.example.alina.testtesta.TabbedActi;
...
public class SampleAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        return  FragmentForDataAdapter.newInstance(position,list.get(position).getName(),
